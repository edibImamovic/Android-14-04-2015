...
import com.example.edibimamovic.loginandpass.singletons.PostFeed;
...
public class PostsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<Post> listAdapter = new ArrayAdapter<Post>(this, android.R.layout.simple_list_item_1,postFeed.getFeed() );
